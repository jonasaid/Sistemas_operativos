...
int main(){
    ...
    inicializarMatriz1(args.mat1);
    imprimirMatriz(args.mat1);

    inicializarMatriz2(args.mat2);
    imprimirMatriz(args.mat2);

    //Creacion de hilos

    pthread_t proceso1, proceso2;
    pthread_create(&proceso1, NULL, &procesoSumarMatriz,&args);
